...
> reales + despliegue). Última actualización: **1 de julio de 2026**.
...
- **NO desplegado en dominio propio todavía** — los precios son referenciales (de Ayenda), confirmar
  con el dueño antes de publicar en el dominio final.
...
- WhatsApp / teléfono usado en el sitio: **+57 350 318 9890** (wa.me/573503189890) — *confirmar que esté activo*
- Google: **4.1 / 5** con **430 reseñas**. Ayenda: **8.2 "Excelente"**.

**Habitaciones (tipos, capacidad, m², tarifa desde — todo real de Ayenda)**
| Tipo | Capacidad | m² | Desde (COP/noche) | Foto en el sitio |
|------|-----------|----|-------------------|------------------|
| Doble | 1-2 personas | 20 m² | $118.000 | `room-doble.webp` (real, mejorada) |
| Twin | 1-2 personas | 20 m² | $130.000 | `room-doble-2.webp` (real, mejorada) |
| Junior Suite | 1-2 personas | — | $153.000 | `barahona-22.webp` |
| Triple | 1-3 personas | 22 m² | $159.000 | `room-triple.webp` (real, mejorada) |
| Cuádruple | 1-4 personas | 24 m² | $165.000 | `room-cuadruple.webp` (real, mejorada) |
...
icono de hueso SVG**, precio desde $118.000, 4.1/430) → manifiesto (modelo en la **sala real** del hotel)
→ 01 Ubicación (mapa + POIs reales) → 02 Negocios/salud → 03 Habitaciones (5 tipos reales, estilo OTA,
...
aggregateRating, geo, 5× `HotelRoom` con m²/ocupación, makesOffer), `BreadcrumbList`, `FAQPage` (7 Q&A).
...
- [ ] **Precios de reserva directa**: confirmar que coincidan o mejoren las tarifas de Ayenda (las
      actuales son las de Ayenda, marcadas como "desde").
- [ ] **WhatsApp/teléfono activo** (+57 350 318 9890).
